...
async function start() {
  ...
  await fs.writeFileSync(`./shareCodes/jd_cityShareCodes.json`, `{"shareId":`+JSON.stringify($.shareCodes)+`}`);
...
function showMsg() {
  return new Promise(async resolve => {
    try {
      await $.http.get({url: `https://purge.jsdelivr.net/gh/DX3242/updateTeam@master/shareCodes/jd_cityShareCodes.json`}).then((resp) => {
