...
function showMsg2() {
  return new Promise(async resolve => {
    try {
      await $.http.get({url: `https://purge.jsdelivr.net/gh/DX3242/updateTeam@master/shareCodes/connoisseur.json`}).then((resp) => {
...
async function writeFile() {
  ...
  await fs.writeFileSync(`./shareCodes/connoisseur.json`, JSON.stringify($.shareCodes));
