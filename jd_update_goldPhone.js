...
async function writeFile() {
    ...
    await fs.writeFileSync(`./shareCodes/jd_jinji.json`, JSON.stringify($.inviteList));
...
async function main() {
    ...
    // }
    // if ($.useInfo.member_team_id === 0 && $.tuanId) {
    //     if ($.index !== 2) {$.authorCode = $.tuanId}
